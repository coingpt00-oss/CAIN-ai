    ...
    <div className="mx-auto max-w-4xl space-y-10 text-sm leading-relaxed text-zinc-200">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          입니다. 하나의 화면에서 시세·차트·뉴스·이벤트·에어드랍 정보와
      ...
      <section className="space-y-3">
        ...
        <p>
          CAIN은 다음에 해당하지 않으며, 그와 같은 역할을 수행하지 않습니다.
        </p>
        <ul className="list-disc space-y-1 pl-5">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          있습니다. CAIN은 특정 국가의 규제기관에 등록된 금융투자업자나
          가상자산사업자가 아니며,{" "}
      ...
      <section className="space-y-3">
        ...
        <p>
          CAIN의 주요 수익원은 다음과 같습니다(현재 또는 향후 계획 포함).
        </p>
        <ul className="list-disc space-y-1 pl-5">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          제공할 수 있습니다. AI의 응답은 통계적 추론에 기반한 결과로,
          사실과 다르거나, 불완전하거나, 최신 정보와 차이가 있을 수 있습니다.
        </p>
        <p>
          AI가 생성한 답변은 <strong>투자·법률·세무 자문이 아니며</strong>,  
          최종 판단 전에는 반드시 원본 데이터·공식 공지·전문가 의견 등을 함께
          검토해 주시길 권장드립니다. 자세한 내용은{" "}
          <Link
            href="/ai-notice"
            className="text-cyan-300 underline underline-offset-2"
          >
      ...
      <section className="space-y-3 border-t border-white/10 pt-6 text-xs text-zinc-400">
        ...
        <p>보다 자세한 내용은 아래 문서를 함께 참고해 주시기 바랍니다.</p>
