      ...
      <section className="space-y-8 text-sm leading-relaxed text-zinc-200">
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            서비스를 제공하지 않으며,{" "}
            <strong>어떠한 코인·토큰·상품의 매수 또는 매도를 권유하지 않습니다.</strong>
          </p>
          <p className="mt-2">
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            있으며, 이용자는 반드시 자신의 재무 상태, 투자 경험, 위험 감내
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            범위가 상이할 수 있으므로, 이용자는 자신의 거주지 규제와 세법을
            스스로 확인해야 합니다.
          </p>
          <p className="mt-2">
