      ...
      <section className="space-y-8 text-sm leading-relaxed text-zinc-200">
        <div>
          ...
          <p className="mt-2">
            ...
            발생하는 경우 일정 비율의 수수료 또는 보상을 받을 수 있사옵니다.
          </p>
          <p className="mt-2">
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            신뢰성, 보안, 고객 응대 등에 대해 책임을 지지 아니하옵니다.
          </p>
          <p className="mt-2">
            이용자는 각 서비스의 개별 이용약관·위험 고지·개인정보처리방침을
            반드시 확인한 뒤 스스로 이용 여부를 결정해야 하옵니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2">
            CAIN은 최신 정보를 제공하기 위해 노력하오나, 모든 제휴 조건의
            실시간 반영을 보증하지 않으며, 실제 적용 조건은 각 제휴사·거래소의
            공지 및 이용약관을 우선으로 하옵니다.
          </p>
        </div>
      </section>
    </CainLegalLayout>
